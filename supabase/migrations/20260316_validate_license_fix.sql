-- ============================================================================
-- Migration: Fix validate_license() — merge multi-product + revoke + rebind
-- Date: 2026-03-16
-- Description: The revoke flag migration (20260316_license_revoke_flag)
--              overwrote multi-product support from 20260315_multi_product.
--              This merges all three features into one correct function.
-- ============================================================================
...
BEGIN
  ...
  -- 11. Return validation result with tier limits + product
