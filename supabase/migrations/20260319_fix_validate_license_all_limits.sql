-- ============================================================================
-- Migration: Definitive validate_license — all limits + all safety checks
-- Date: 2026-03-19
-- Description: Previous migrations overwrote validate_license in conflicting
--              order, resulting in the final function missing vlanEnabled,
--              maxVlans, sessionRoaming, and pppoeEnabled from the limits
--              response. This combines the complete safety checks (revoke,
--              audit, decommission) with ALL limit fields the device expects.
-- ============================================================================
