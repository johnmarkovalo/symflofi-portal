-- ============================================================================
-- Migration: Fix validate_license — restore revoke/audit/unbind checks
-- Date: 2026-03-18
-- Description: The 20260318_tier_features_jsonb migration accidentally
--              overwrote validate_license without is_revoked check, audit
--              logging, and machine decommission logic. This restores all
--              of that AND adds the features JSONB to the response.
-- ============================================================================
