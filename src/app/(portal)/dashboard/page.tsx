...
export default async function DashboardPage() {
  ...
  const stats = [
    ...
    { label: "Active Licenses", value: activeCount ?? 0, icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z", color: "text-emerald-400", bg: "bg-emerald-500/10", border: "border-emerald-500/20" },
